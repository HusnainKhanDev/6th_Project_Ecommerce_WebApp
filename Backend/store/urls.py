...
from .views import get_products, get_category, get_cart, add_to_cart, orders, get_orders, delete_from_cart, direct_buy, update_cart_qty
...
urlpatterns = [
    ...
    path('cart/update/quantity/', update_cart_qty.as_view()),
    path('order/', orders.as_view()),
    path('get/order/', get_orders.as_view()),
    path('buy/', direct_buy.as_view()),
