"""
Django settings for ProjConfig project.
...
SECRET_KEY = 'django-insecure-^ox28)1@670z=l0kxms1ym2ox$-a^h(=6n+$2kk*kho(b(d$xw'
...
WSGI_APPLICATION = 'ProjConfig.wsgi.application'
